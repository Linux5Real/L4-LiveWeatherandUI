...
Config.ApiKey = "Your-API-Key-Change-It" -- your API key from openweathermap.org 
Config.City = "Münster" -- https://openweathermap.org Search your city and copy thhe name here 
...
Config.Debug = true -- Debug-Mode true/false